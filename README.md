...
Gemensams är ett självhostat hushållsutgiftssystem — ekonomi för de med gemensam ekonomi som gör dig transparent.

Gemensams is a self-hosted Swedish household expense tracker, forked from [Spliit](https://github.com/spliit-app/spliit) (MIT). See `NOTICE` and `LICENSE` for upstream attribution.

---

*Original Spliit description:*
